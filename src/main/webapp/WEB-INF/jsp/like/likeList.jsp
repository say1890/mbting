        ...
        <c:forEach var="user" items="${likeList}">
          <div class="swiper-slide">
            <div id="profile-box" class="bg-white  mx-auto">
              ...
              <div id="recommended-profile-introduce"
              ...
              <div class="d-flex justify-content-around">
                ...
                <c:choose>
                  <c:when test="${user.like}">
                    <a href="#"> <i
                      class="bi bi-suit-heart-fill menu-icon text-danger likedBtn"
                      data-your-id="${user.user.id}"></i>
                    </a>
                  </c:when>
                  <c:otherwise>
                    <a href="#"> <i
                      class="bi bi-suit-heart menu-icon text-danger likeBtn"
                      data-your-id="${user.user.id}"></i>
                    </a>
                  </c:otherwise>
                </c:choose>
                ...
                <!-- 좋아요  끝-->
                <a href="#"> <i
                  class="bi bi-trash-fill menu-icon text-dark "></i>
                </a>
