    ...
    <section class="d-flex justify-content-center">
      <div class="w-75 my-5">
        ...
        <div class="d-flex mt-5">
          <label class="mr-2 mt-2">제목:</label> <input type="text"
            class="form-control col-11" placeholder="제목 입력"
            id="titleInput">
        </div>

        <div class="d-flex mt-5">
          <label class="mr-2 mt-2">날짜:</label> <input type="date"
            class="form-control col-11" id="dateInput">
        </div>
