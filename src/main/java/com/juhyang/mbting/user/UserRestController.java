...
public class UserRestController {
  ...
  public Map<String, String> signUp(@RequestParam("loginId") String loginId,
      ...
      @RequestParam("mbti") String mbti, @RequestParam("email") String email)
  ...
  public String sendMail(@RequestParam("email") String email)
    ...
    if (result == 1) {
      ...
      String content = System.getProperty("line.separator") + "안녕하세요 회원님:)"
          + System.getProperty("line.separator") + "회원님의 id는 " + loginId + " 이고," + "회원님의 변경된 pw는 "
  ...
  public int editProfile(@RequestParam("userName") String userName,
      @RequestParam("introduce") String introduce, @RequestParam("mbti") String mbti,
    ...
    return userBO.editMatchingProfile(userId, myMeritArr, myHobbyArr, myCharacterArr, yourMeritArr,
        yourHobbyArr, yourCharacterArr, ageArr);
