...
public interface UserDAO {
	...
	public void InsertUser(@Param("loginId") String loginId, @Param("password") String password,
			@Param("userName") String userName, @Param("birthday") Date birthday, @Param("sex") String sex,
			@Param("mbti") String mbti, @Param("email") String email
	...
	public int updateBasicProfile(@Param("userId") int userId, @Param("userName") String userName,
			@Param("introduce") String introduce, @Param("mbti") String mbti, @Param("profile") String filePath);
	...
	public void updateBasicProfileExceptFile(@Param("userId") int userId, @Param("userName") String userName,
