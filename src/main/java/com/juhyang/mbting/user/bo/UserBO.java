...
public class UserBO {
	...
	// 사용자 추가
	public void addUser(String loginId, String password, String userName, Date birthday, String sex, String mbti,
			String email) {
...
//				사용자가 원하는 나이의 user 정보를 가져옴
	...
	public List<UserDetail> returnRecommendedUser(List<UserCharacter> yourInfo, List<UserCharacter> myInfo,
			int userId) {
